...
<body>
	<div class="container-fluid">
		...
		<button onclick="window.print()" style="background-color:rgba(245, 6, 170, 1);" class="float-right btn btn-sm text-white mt-3">Print</button>
		<div class="row justify-content-center mt-5">
			<div class="col-lg-12 mt-3 ider"> 
				<div class="col-lg-12 " style="
						background-color:rgb(245, 6, 170);
						color: white;
						padding: 10px;
					">
						Details for Candidate with id number <strong>#<?php echo$_GET['U']?></strong>
				</div>
				<div class="col-lg-12 border ">
					<?php
					$id=$_GET['U'];
						$selectall=mysqli_query($conn, "SELECT * FROM candidate,grade where candidate.unique_id='$unique_id' and candidate.candidatanationalid=grade.candidatanationalid and candidate.candidatanationalid='$id'")or die($conn->error); 
