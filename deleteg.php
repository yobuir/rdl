...
<?php
  ...
  $id=$_GET['U'];
    if (isset($_POST['send'])) {   
        $sg=mysqli_query($conn, "DELETE FROM grade WHERE candidatanationalid='$id'");
                 if ($sg) {
                    $message="<div class='alert alert-success'><i class='fa fa-info-circle'></i> Grade deleted successful</div>";
                  } else{
		...
		<div class="col-lg-6 ml-5">
			<form class="row ml-5 sticky-top" method="POST">
					<div class="col-lg-12  sticky-top" style="
						...
						padding: 10px;
					">
						Delete grade for Candidate <strong>with ID#<?php echo$_GET['U']?></strong>
					</div>
					...
					">
						...
						<a href="dashboard.php" class="btn float-right font-weight-bold text-decoration-none" 
						style="
				...
				<?php }else{?>
					<div class='col-lg-12 alert alert-danger'><i class='fa fa-info-circle'></i> No Candidate grade found <a href="dashboard.php"><strong>Back to home</strong></a></div>
				<?php }?>
